...
class Jaipur extends React.Component {    
...
this.props.navigation.navigate("appNav4")
  ...
  render() {
    return (
      ...
      <View style= {{marginTop: -10, marginLeft: -20}}>
      <TouchableOpacity style= {styling.Button} onPress={()=>{this.triggerCalling('108')}}><Text>Ambulance</Text></TouchableOpacity></View>
      ...
      <TouchableOpacity style= {styling.Button}  onPress={()=>{this.triggerCalling('1098')}}><Text>Child Helpline</Text></TouchableOpacity></View>
       ...
       <View style= {{marginTop: -10, marginLeft: -20}}>
      <TouchableOpacity style= {styling.Button} onPress={()=>{this.triggerCalling('1906')}}><Text>Disaster Management </Text></TouchableOpacity></View>
