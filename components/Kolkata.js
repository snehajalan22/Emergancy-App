...
this.props.navigation.navigate("appNav4")
  ...
  render() {
    return (
      ...
      <View style= {{marginTop: -10, marginLeft: -20}}>
      <TouchableOpacity style= {styling.Button} onPress={()=>{this.triggerCalling('22485277')}}><Text>Ambulance</Text></TouchableOpacity></View>

      <View style= {{marginTop: -10, marginLeft: -20}}>
      <TouchableOpacity style= {styling.Button}  onPress={()=>{this.triggerCalling(' 2244 0101')}}><Text>Fire</Text></TouchableOpacity></View>
