...
class Dehli extends React.Component {    
...
this.props.navigation.navigate("appNav4")
  ...
  render() {
    return (
      ...
      <TouchableOpacity style= {styling.Button} onPress={()=>{this.triggerCalling('100')}}><Text>Police</Text></TouchableOpacity></View>

      <View style= {{marginTop: -10, marginLeft: -20}}>
      <TouchableOpacity style= {styling.Button} onPress={()=>{this.triggerCalling('102')}}><Text>Ambulance</Text></TouchableOpacity></View>

      <View style= {{marginTop: -10, marginLeft: -20}}>
      <TouchableOpacity style= {styling.Button}  onPress={()=>{this.triggerCalling('101')}}><Text>Fire</Text></TouchableOpacity></View>

      <View style= {{marginTop: -10, marginLeft: -20}}>
      <TouchableOpacity style= {styling.Button}  onPress={()=>{this.triggerCalling('1098')}}><Text>Child Helpline</Text></TouchableOpacity></View>
      

       <View style= {{marginTop: -10, marginLeft: -20}}>
      <TouchableOpacity style= {styling.Button} onPress={()=>{this.triggerCalling('1077')}}><Text>Disaster Management </Text></TouchableOpacity></View>
